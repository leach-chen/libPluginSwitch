package com.leachchen.plugin

import com.leachchen.plugin.exten.CompileExtension
...
class CompileSwitch implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        String modulefoldername = project.rootProject.property("modulefoldername")
        String module = project.path.replace(":", "").replace(modulefoldername,"")
    ...
    private void compileComponents(AssembleTask assembleTask, Project project) {
        ...
        for (String str : compileComponents) {
            ...
            if (str.contains(":release")) {
                ...
                String modulefoldername = project.rootProject.property("modulefoldername")
                if(modulefoldername.length() > 0) {
                    project.dependencies.add("implementation", project.project(':'+ str))
                }else
                {
                    project.dependencies.add("implementation", project.project(':'+modulefoldername+':'+ str))
                }
